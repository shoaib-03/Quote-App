  ...
  return (
    <div className="home-wrapper">
      {loadingStatus ? (
        ...
        <div className="make-post-wrapper following-wrapper">
          <p>Follow other users to see their awesome work...</p>
          <p>
        ...
        data.map((item, pos) => {
          return (
            <div className="card post-card" id={item.postedBy._id} key={pos}>
      ...
      <Link
        to="/create"
        className="btn-floating btn-large waves-effect waves-light red post-btn"
        title="Create Post"
      >
        <svg
          width="43"
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M21.7466 40.5C32.2396 40.5 40.7466 31.993 40.7466 21.5C40.7466 11.007 32.2396 2.5 21.7466 2.5C11.2536 2.5 2.74658 11.007 2.74658 21.5C2.74658 31.993 11.2536 40.5 21.7466 40.5V40.5Z"
            stroke="#43484D"
            strokeWidth="3.92"
            strokeLinecap="round"
          />
